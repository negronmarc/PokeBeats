    ...
    .then((data) => { 
      ...
      typeBox.innerHTML = data.types[0].type.name;
        if (data.types[0].type.name === "electric") {
          ...
          cardBackground.style.backgroundImage = "linear-gradient(#f0e20d, #f4f5d2, #f0e20d, #f4f5d2, #f0e20d)";
          ...
          cardBackground.style.backgroundImage = "linear-gradient(#0f6896, #659cd0, #0f6896, #659cd0, #0f6896)";
          ...
          cardBackground.style.backgroundImage = "linear-gradient(#7f5880, #bcb6d9, #7f5880, #bcb6d9, #7f5880)";
          ...
          cardBackground.style.backgroundImage = "linear-gradient(#ed5d40, #edb69c, #ed5d40, #edb69c, #ed5d40)";
          ...
          cardBackground.style.backgroundImage = "linear-gradient(#d1c3ae, #e2e1dd, #d1c3ae, #e2e1dd, #d1c3ae)";
          ...
          cardBackground.style.backgroundImage = "linear-gradient(#b2612a, #dbc091, #b2612a, #dbc091, #b2612a)";
          ...
          cardBackground.style.backgroundImage = "linear-gradient(#63747b, #b1cdd8, #63747b, #b1cdd8, #63747b)";
          ...
          cardBackground.style.backgroundImage = "linear-gradient(#93c85e, #bcd27d, #93c85e, #bcd27d, #93c85e)";
          ...
          cardBackground.style.backgroundImage = "linear-gradient(#cbc2a1, #faf9ee, #cbc2a1, #faf9ee, #cbc2a1)";
        ...
        versionList.innerHTML = `First Video Game Appearance: Pokemon ${data.game_indices[0].version.name}/${data.game_indices[1].version.name}`;
          if (data.game_indices[0].version.name === "red", data.game_indices[1].version.name === "blue") {
          ...
          } else if (data.game_indices[0].version.name === "gold", data.game_indices[1].version.name === "silver") {
          ...
          } else if (data.game_indices[0].version.name === "ruby", data.game_indices[1].version.name === "sapphire") {
          ...
          } else if (data.game_indices[0].version.name === "diamond", data.game_indices[1].version.name === "pearl") {
